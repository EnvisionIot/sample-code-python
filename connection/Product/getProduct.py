 ...
 *
 * https://support.envisioniot.com/docs/connection-api/en/2.3.0/get_product.html
...
def GetProduct(accessKey, secretKey, orgId, url, productKey):
    accessURL = url + '/connect-service/v2.1/products'
    params = {"action": "get", "orgId" : orgId, "productKey" : productKey}
    req = PreparedRequest()
