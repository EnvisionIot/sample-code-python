 ...
 * FileName: removeOrganizationStructures
 * Author:  Dylan Yeo
 * Date:    18/03/22
...
def removeOrganizationStructures(accessKey, secretKey, orgId, url):
    accessURL = url + "/app-portal-service/v2.2/structure/removeStructures"
    params = {}
    req = PreparedRequest()
