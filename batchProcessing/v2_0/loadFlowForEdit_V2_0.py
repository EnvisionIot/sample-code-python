 ...
 * FileName: loadFlowForEdit_V2_0
 * Author:  Dylan Yeo
 * Date:    14/03/22
 * Description: Load the specified workflow to a temporary workflow to get the workflow information
 * <author>          <time>          <version>          <desc>
 *
 * https://support.envisioniot.com/docs/batch-processing-api/en/2.3.0/v2.0/load_flow_for_edit.html
"""

import poseidon.poseidon
from requests.models import PreparedRequest

def loadFlowForEdit_V2_0(accessKey, secretKey, orgId, url, userId, flowId):
